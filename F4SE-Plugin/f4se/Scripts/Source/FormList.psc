...
; For each form in the passed array, returns the index of the first keyword found in the FormList.
; The size of the index array is the same size of the passed array. If no keyword is found for a form, -1 is used.
Int[] Function FindFormsByKeywords(Form[] forms) native
